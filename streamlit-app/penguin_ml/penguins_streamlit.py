...
if penguin_file is None:
    rf_pickle = open(r"/ughhhh/streamlit-app/penguin_ml/random_forest_penguin.pickle", "rb")
    map_pickle = open(r"/ughhhh/streamlit-app/penguin_ml/output_penguin.pickle", "rb")
