...
rf_pickle = open("/workspaces/ughhhh/streamlit-app/penguin_ml/random_forest_penguin.pickle", "wb")
pickle.dump(rfc, rf_pickle)
rf_pickle.close()
output_pickle = open("/workspaces/ughhhh/streamlit-app/penguin_ml/output_penguin.pickle", "wb")
