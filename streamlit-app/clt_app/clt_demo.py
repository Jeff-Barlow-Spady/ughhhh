...
st.subheader('An App by Jeff Barlow-Spady - credit to tyler richards')
st.write(("This app simulates a thousand coin flips using the chance of heads input below\
     and then samples with replacement from that population and plots the histogram\
         of the means of the samples in order to illustrate the central limit theorem!"))
